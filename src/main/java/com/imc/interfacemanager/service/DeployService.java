...
public class DeployService {
	...
	public void processAsyncDeploy(String interfaceId, List<String> adapterIds) {
		...
		int deployVersion = createDeployHistory(interfaceId, adapterIds);
	...
	private int createDeployHistory(String interfaceId, List<String> adapterIds) {
		try {
	...
	public void updateDeployResult(String interfaceId, String statusCode, String errorMessage, int deployVersion) {
